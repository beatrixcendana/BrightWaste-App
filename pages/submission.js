            ...
            <div className='d-flex justify-content-center align-items-center flex-wrap'>
                ...
                <form>
                    ...
                    <div className='form-group row mt-3 mb-3'>
                        ...
                        <textarea cols="5" rows="5" style={{ backgroundColor: '#469D8C' }} className='form-control border-0 bg-light'></textarea>
                    </div>
                    ...
                    <div className='form-group row mt-3 mb-3'>
                        ...
                        <div className='row'>
                            <div className='col-lg-2 col-sm-2 col-md-2 me-2'>
                                <input type="file" style={{ backgroundColor: '#469D8C' }}  className='form-control'/>
                            </div>
                            <div className='col-lg-2 col-sm-2 col-md-2 me-2'>
                                <input type="file" style={{ backgroundColor: '#469D8C' }} className='form-control'/>
                            </div>
                    ...
                    <div className='form-group row mt-3 mb-3'>
                        <div className='col-lg-2 col-md-2 col-sm-2 me-3'>
                            <label className= {styles.labelpayment}>
                                <input type="radio" name="payment" className= {styles.inputRadio}/>
                    ...
                    <div className='form-group row mt-3 mb-3'>
                        ...
                        <input type="text" placeholder="Lacey, WA, US" style={{ backgroundColor: '#469D8C' }} className="form-control border-0 bg-light"/>
                    </div>
